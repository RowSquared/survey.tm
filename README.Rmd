...
Simple wrapper for the DeepL API, utilizing the [`deeplr`](https://github.com/zumbov2/deeplr#readme) package. For more details on setting up Google Translate API and obtaining authentication details, visit [Google Cloud Translation](https://cloud.google.com/translate/docs/setup).
...
- [ ] Color coding as dedicated function? Not really like it. It is a one liner. Add to doc as an example?
