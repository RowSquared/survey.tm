...
Before working with one or more questionnaires, you need to run once the `setup_tdb()` function to get a google worksheet that will serve as the "Translation Database Sheet". 

Please note: If you have not used any functionality of package `googlesheets4` before, at first run of any `survey.tm` function, you will need to generate an access token. Follow instructions in console and browser.
...
At first run after `setup_tdb()`, all elements of the list returned will be empty data.table's. 
</details>
