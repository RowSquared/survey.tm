...
Please note: To work with [Google Sheets](https://www.google.com/sheets/about/), you must have a valid Google account. If you have not used any functionality of package `googlesheets4` before, you will need to generate an access token. Follow instructions in console and browser after you ran `setup_tdb()`.
