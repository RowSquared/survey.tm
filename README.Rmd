...
Before working with one or more questionnaires, you need to run once the `setup_tsheet()` function to get a google worksheet that will serve as the "Translation Master Sheet". 
